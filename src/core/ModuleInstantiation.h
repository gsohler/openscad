...
public:
  ...
  virtual void print_python(std::ostream& stream, std::ostream& stream_def, const std::string& indent, const bool inlined, const bool skip_brackets) const;
  void print(std::ostream& stream, const std::string& indent) const override { print(stream, indent, false); }
  void print_python(std::ostream& stream, std::ostream& stream_def, const std::string& indent) const override { print_python(stream, stream_def, indent, false, false); }
...
public:
  ...
  void print_python(std::ostream& stream, std::ostream& stream_ref,const std::string& indent, const bool inlined, const bool skip_brackets) const final;
private:
