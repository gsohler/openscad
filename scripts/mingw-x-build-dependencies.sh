...
PACKAGES='qtbase qtmultimedia qscintilla2 mpfr eigen opencsg cgal ninja nsis glib libxml2 freetype fontconfig harfbuzz libzip lib3mf double-conversion zip cryptopp intel-tbb nettle glm  curl tbb clipper2'
fi
echo aaa
